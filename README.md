...
float  MIN_VALUE (наим. положительное) = 1.4E-45
float  MAX_VALUE (наиб. значение)      = 3.4028235E38
double MIN_VALUE (наим. положительное) = 4.9E-324
double MAX_VALUE (наиб. значение)      = 1.7976931348623157E308
...
